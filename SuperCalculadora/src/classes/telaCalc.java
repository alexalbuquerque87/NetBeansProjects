...
public class telaCalc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/CalcIcon.jpg"))); // NOI18N
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        // Get valor do Spinner txtNum, toString then parseInt:
        ...
        //lblRaizQ.setText(Double.toString(rq)); //sem formatação
        lblRaizQ.setText(String.format("%.3f",rq)); //formatado com 3 casas dec
